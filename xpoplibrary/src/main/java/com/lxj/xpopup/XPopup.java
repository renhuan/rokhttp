...
public class XPopup {
     ...
     * @return
     */
    public XPopup asConfirm(String title, String content, OnConfirmListener confirmListener, OnCancelListener cancelListener, boolean isHideCancel, String comfirmText) {
        ...
        popupView.setComfirmText(comfirmText);
    ...
    public XPopup asConfirm(String title, String content, OnConfirmListener confirmListener, OnCancelListener cancelListener) {
        return asConfirm(title, content, confirmListener, null, false, null);
    }
     ...
     * @return
     */
    public XPopup asInputConfirm(String title, String content, String hint, OnInputConfirmListener confirmListener, OnCancelListener cancelListener, int type) {
        position(PopupType.Center);

        InputConfirmPopupView popupView = new InputConfirmPopupView(contextRef.get());
        popupView.setTitleContent(title, content, hint);
        popupView.setListener(confirmListener, cancelListener);
        popupView.setInputType(type);
        this.tempView = popupView;
        return this;
    }

    public XPopup asInputConfirm(String title, String content, String hint, OnInputConfirmListener confirmListener) {
        return asInputConfirm(title, content, hint, confirmListener, null, InputType.TYPE_CLASS_TEXT);
    }

    public XPopup asInputConfirm(String title, String content, OnInputConfirmListener confirmListener) {
        return asInputConfirm(title, content, null, confirmListener, null, InputType.TYPE_CLASS_TEXT);
    }
